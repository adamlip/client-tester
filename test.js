...
var fs = require('fs')
let puggy = pug.compileFile("./Torzshely_new_order_customer.pug")
...
axios('https://kfg55cde.okeoke.io/api/v1/order/getOrder', {      
    method: 'post',
    data: {
        "orderUUID": "11EB6C7266B54780B494A5849670AC5E", 
        "informational": true
    }
}).then(res => {
